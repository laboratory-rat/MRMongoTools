...
namespace MRMongoTools.Extensions.Identity.Store
{
    ...
    public class MRUserStore<TUser> : MRRepository<TUser>, IMRUserStore<TUser>
        where TUser : MRUser, new()
    {
        public MRUserStore(MRDatabaseConnectionSettings settings) : base(settings) { }

        protected override QueryBuilder<TUser> _builder =>
            new QueryBuilder<TUser>()
        ...
        protected virtual QueryBuilder<TUser> _clearBuilder => new QueryBuilder<TUser>();
